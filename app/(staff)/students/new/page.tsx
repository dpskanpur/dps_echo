...
import { listAdmissionSessions, getActiveSessionName } from "@/lib/academic-session";
...
export default async function NewAdmissionPage({
  ...
  // Only the current session and future ones may receive an admission.
  const admissionSessions = await listAdmissionSessions();
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[10px] text-slate-400">
                    Current or upcoming session only.
                  </p>
                </div>
              </div>
            </div>
