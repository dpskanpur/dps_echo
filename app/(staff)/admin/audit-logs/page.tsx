...
export default async function AuditLogsPage({ searchParams }: AuditLogsPageProps) {
  ...
  return (
    <div className="flex h-screen bg-slate-900 text-slate-100 font-sans overflow-hidden">
      <Sidebar currentUser={currentUser} permissions={permissions} />

      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <Navbar user={currentUser} title="User Audit Logs & Activity History" />
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Complete activity log tracking all staff mutations, logins, fee edits, and student record updates.
                </p>
              </div>
            </div>
